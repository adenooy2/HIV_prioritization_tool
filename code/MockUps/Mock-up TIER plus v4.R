...
regional_presets <- list(
  "Eastern Africa - High Prevalence" = list(
    description = "Generalized epidemic (Kenya, Uganda, Tanzania)",
    context = list(
      total_population = 5000000,
      hiv_prevalence = 0.045,
      new_infections_per_year = 8500,
      current_diagnoses = 7000,
      percent_on_art = 78,
      percent_suppressed = 85,
      aids_deaths_per_year = 2200
    ),
    baseline = list(
      prep_oral = 12000, prep_lenacapavir = 0, vmmc = 85000,
      condoms = 450000, pep = 3500, infant_prophylaxis = 85,
      cotrimoxazole = 70, test_facility = 95000, test_community = 45000,
      test_kpsti = 12000, hivst_facility = 18000, hivst_community = 8000,
      eid = 80, anc_hiv_testing = 92,
      vl_monitoring_routine = 65, vl_monitoring_targeted = 2500,
      oi_management = 55, mmd_3month = 45, mmd_6month = 25, mmd_12month = 5,
      adherence_counseling = 60, tracking_tracing = 40, anc_vl_testing = 75,
      cd4_testing = 95, ahd_package = 90
    )
  ),
  
  "Southern Africa - Very High Prevalence" = list(
    description = "Highest burden (eSwatini, Lesotho, South Africa)",
    context = list(
      total_population = 3000000,
      hiv_prevalence = 0.215,
      new_infections_per_year = 11000,
      current_diagnoses = 9500,
      percent_on_art = 85,
      percent_suppressed = 88,
      aids_deaths_per_year = 3800
    ),
    baseline = list(
      prep_oral = 25000, prep_lenacapavir = 500, vmmc = 45000,
      condoms = 380000, pep = 5500, infant_prophylaxis = 90,
      cotrimoxazole = 80, test_facility = 125000, test_community = 75000,
      test_kpsti = 18000, hivst_facility = 35000, hivst_community = 15000,
      eid = 88, anc_hiv_testing = 95,
      vl_monitoring_routine = 80, vl_monitoring_targeted = 3500,
      oi_management = 70, mmd_3month = 60, mmd_6month = 35, mmd_12month = 10,
      adherence_counseling = 75, tracking_tracing = 55, anc_vl_testing = 82,
      cd4_testing = 98, ahd_package = 92
    )
  ),
  
  "West/Central Africa - Concentrated" = list(
    description = "Lower prevalence, KP-focused (Nigeria, Ghana)",
    context = list(
      total_population = 8000000,
      hiv_prevalence = 0.018,
      new_infections_per_year = 6200,
      current_diagnoses = 4500,
      percent_on_art = 68,
      percent_suppressed = 75,
      aids_deaths_per_year = 1800
    ),
    baseline = list(
      prep_oral = 5500, prep_lenacapavir = 0, vmmc = 42000,
      condoms = 280000, pep = 1800, infant_prophylaxis = 65,
      cotrimoxazole = 55, test_facility = 62000, test_community = 28000,
      test_kpsti = 15000, hivst_facility = 8500, hivst_community = 4000,
      eid = 70, anc_hiv_testing = 85,
      vl_monitoring_routine = 52, vl_monitoring_targeted = 1500,
      oi_management = 45, mmd_3month = 30, mmd_6month = 15, mmd_12month = 3,
      adherence_counseling = 50, tracking_tracing = 35, anc_vl_testing = 60,
      cd4_testing = 88, ahd_package = 85
    )
  ),
